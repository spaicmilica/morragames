...
// RPS app
const appIndex = 177557538;
const appAddress = "PK5AFEHPIQJSLC2ITSRK2ZL6TNN5QTT4GRDS3KIZCBJFXYGB3CTTBJKNXI";
...
function App() {
  ...
  async function startRpsApplication(
    ...
    try {
      ...
      const accounts = [
        "TBW56GZFBKGGTMQX26JBPZQ7YYAJCXRAX7RUDKGUMGDDZC4VJGXCUJCL5U",
      ];
  ...
  async function joinRpsApplication(sum) {
    try {
      ...
      const accounts = [
        "UACV63RAYVRBBYLVKNNIC7VMB76TPOGFPBFI4P5O5D24IKRRWSAPNQC5ZI",
      ];
